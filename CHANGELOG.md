...
## 1.7.3
* Fix `!` not being quoted correctly when present in a string that also contains `'`. ([@raxod502](https://github.com/raxod502) in [#49](https://github.com/substack/node-shell-quote/pull/49))
